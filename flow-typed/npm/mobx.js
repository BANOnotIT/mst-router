declare module "mobx" {
    ...
    declare interface IObservableArray<T> extends Array<T> {
        ...
        observe(listener: (changeData: IArrayChange<T> | IArraySplice<T>) => void,
        ...
        find(predicate: (item: T, index: number, array: Array<T>) => boolean,
             thisArg?: any,
             fromIndex?: number): T | any,

        findIndex(predicate: (item: T, index: number, array: Array<T>) => boolean,
                  thisArg?: any,
    ...
    declare class IObservableFactories {
        ...
        shallowMap<T>(initialValues?: IObservableMapInitialValues<T>,
                      name?: string): ObservableMap<T>,
    ...
    declare class ObservableMap<V> {
        ...
        forEach(callback: (value: V, key: string, object: IKeyValueMap<V>) => void,
                thisArg?: any): void,
    ...
    declare function action(targetOrName: any,
    ...
    declare function autorun(nameOrFunction: string | ((r: IReactionPublic) => any),
                             viewOrScope?: any,
                             scope?: any): any
    ...
    declare function autorunAsync(func: (r: IReactionPublic) => any,
                                  delay?: number,
                                  scope?: any): any

    declare function reaction<T>(expression: (r: IReactionPublic) => T,
                                 effect: (arg: T, r: IReactionPublic) => void,
                                 fireImmediately?: boolean,
                                 delay?: number,
                                 scope?: any): any

    declare function computed<T>(target: any,
                                 key?: string,
                                 baseDescriptor?: PropertyDescriptor): any

    declare function createTransformer<A, B>(transformer: ITransformer<A, B>,
                                             onCleanup?: (resultObject: ?B | any, sourceObject?: A) => void): ITransformer<A, B>
    ...
    declare function observe<T>(value: IObservableValue<T> | IComputedValue<T>,
                                listener: (change: IValueDidChange<T>) => void,
                                fireImmediately?: boolean): Lambda

    declare function observe<T>(observableArray: IObservableArray<T>,
                                listener: (change: IArrayChange<T> | IArraySplice<T>) => void,
                                fireImmediately?: boolean): Lambda

    declare function observe<T>(observableMap: ObservableMap<T>,
    ...
    declare function observe(object: any,
    ...
    declare function toJSlegacy(source: any,
                                detectCycles?: boolean,
                                ___alreadySeen?: [any, any][]): any
    ...
    declare function map<V>(initialValues?: IMapEntries<V> | IKeyValueMap<V>,
                            valueModifier?: Function): ObservableMap<V>
    ...
    declare class Atom {
        ...
        constructor(name?: string,
                    onBecomeObservedHandler?: () => void,
                    onBecomeUnobservedHandler?: () => void): this,
